export const metadata = {
  ...
  description: 'پاکستان نیوز پوائنٹ کی پرائیویسی پالیسی',
};
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="max-w-3xl mx-auto bg-white rounded-xl shadow-sm p-8">
        ...
        <div className="space-y-4 leading-loose">
          <p>
            پاکستان نیوز پوائنٹ آپ کی پرائیویسی کا احترام کرتا ہے۔ یہ پالیسی
          ...
          <p>
            ...
            کرتے ہیں یا نیوز لیٹر سبسکرائب کرتے ہیں۔
          </p>
          ...
          <h2 className="text-xl font-bold mt-6">کوکیز</h2>
          <p>
            ہم اپنی ویب سائٹ کو بہتر بنانے کے لیے کوکیز استعمال کر سکتے ہیں۔
            آپ اپنے براؤزر کی سیٹنگز سے کوکیز کو کنٹرول کر سکتے ہیں۔
          </p>
