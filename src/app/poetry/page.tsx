...
const couplets: Couplet[] = [
  ...
  { first: 'پتہ پتہ بوٹا بوٹا حال ہمارا جانے ہے', second: 'جانے نہ جانے گل ہی نہ جانے باغ تو سارا جانے ہے', poet: 'میر تقی میر', genre: 'غزل' },
  ...
  { first: 'شرم، وحشت، جھجک، پریشانی', second: 'ناز سے کام کیوں نہیں لیتیں', poet: 'جان ایلیا', genre: 'غزل' },
